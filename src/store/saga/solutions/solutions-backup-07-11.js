...
export function* matchUserDataSaga(action) {
  ...
  try {
    let respData = yield axios("/api/storeUserMappedData", {
      method: "post",
      // params: {
      //   instanceID: action.payload,
      // },
...
export function* fetchMapFieldCompanyList(action) {
  ...
  try {
    ...
    console.log(e);
    yield put(actions.fetchmapCompanyDataFail("Unable to fecth SalesForce user list"));
    yield put(actions.hideLoader());
  }
}
...
export function* mappedCompanyDataSaga(action) {
  ...
  try {
    let respData = yield axios("/api/dataMapping/storeCompanyMappedData", {
      method: "post",
      // params: {
      //   instanceID: action.payload,
      // },
...
export function* refreshMapFieldCompanyListSaga(action) {
  ...
  try {
    ...
    console.log(e);
    yield put(actions.refreshCompanyDataFail("Unable to fecth SalesForce user list"));
    yield put(actions.hideLoader());
  }
}
...
export function* fetchMapFieldContactListSaga(action) {
  ...
  try {
    ...
    console.log(e);
    yield put(actions.fetchMapContactDataFail("Unable to fecth the Contact Data list"));
    yield put(actions.hideLoader());
  }
}
...
export function* mappedContactDataSaga(action) {
  ...
  try {
    let respData = yield axios("/api/dataMapping/storeContactMappedData", {
      method: "post",
      // params: {
      //   instanceID: action.payload,
      // },
...
export function* fetchMapFieldDealsListSaga(action) {
  ...
  try {
    ...
    console.log(e);
    yield put(actions.fetchMapDealsDataFail("Unable to fecth the Deals Data list"));
    yield put(actions.hideLoader());
  }
}
...
export function* mappedDealsDataSaga(action) {
  ...
  try {
    let respData = yield axios("/api/dataMapping/storeDealMappedData", {
      method: "post",
      // params: {
      //   instanceID: action.payload,
      // },
    ...
    yield put(
      actions.mappedDealsDataSuccess(respData.data.data, respData.data.msg, respData.data.status) //"Adding data to the Api and redux")
    );
    yield put(actions.upgradeSolutionInstance(respData.data.data.instanceId));
    yield put(
      actions.hideLoader({
...
export function* refreshMapFieldDealsListSaga(action) {
  ...
  try {
    ...
    console.log(e);
    yield put(actions.refreshDealsDataFail("Unable to fecth the Deals Data list"));
    yield put(actions.hideLoader());
  }
}
...
export function* upgradeSolutionInstanceSaga(action) {
  ...
  try {
    ...
    yield put(actions.upgradeSolutionInstanceFail("Unable to upgrade the solution instance "));
    yield put(actions.hideLoader());
  }
}
...
export function* fetchMapFieldProductListSaga(action) {
  ...
  try {
    ...
    console.log(e);
    yield put(actions.fetchMapProductsDataFail("Unable to fecth the Product Data list"));
    yield put(actions.hideLoader());
  }
}
...
export function* mappedProductsDataSaga(action) {
  ...
  try {
    ...
    yield put(
      actions.mappedProductDataSuccess(respData.data.data, respData.data.msg, respData.data.status) //"Adding data to the Api and redux")
    );
    yield put(actions.upgradeSolutionInstance(respData.data.data.instanceId));
    yield put(
      actions.hideLoader({
...
export function* refreshMapFieldProductListSaga(action) {
  ...
  try {
    ...
    console.log(e);
    yield put(actions.refreshProductDataFail("Unable to refresh the Product Data list"));
    yield put(actions.hideLoader());
  }
}
...
export function* fetchMapFieldTicketListSaga(action) {
  ...
  try {
    ...
    console.log(e);
    yield put(actions.fetchMapTicketDataFail("Unable to fetch the Product Data list"));
    yield put(actions.hideLoader());
  }
}
...
export function* mappedTicketDataSaga(action) {
  ...
  try {
    let respData = yield axios("/api/dataMapping/storeTicketMappedData", {
      method: "post",
      // params: {
      //   instanceID: action.payload,
      // },
    ...
    yield put(
      actions.mappedTicketDataSuccess(respData.data.data, respData.data.msg, respData.data.status) //"Adding data to the Api and redux")
    );
    yield put(actions.upgradeSolutionInstance(respData.data.data.instanceId));
    yield put(
      actions.hideLoader({
...
export function* refreshMapFieldTicketListSaga(action) {
  ...
  try {
    ...
    console.log(e);
    yield put(actions.refreshTicketDataFail("Unable to refresh the Ticket list"));
    yield put(actions.hideLoader());
  }
}
...
export function* mappedEmailDataSaga(action) {
  ...
  try {
    ...
    yield put(
      actions.mappedEmailDataSuccess(respData.data.data, respData.data.msg, respData.data.status) //"Adding data to the Api and redux")
    );
    yield put(actions.upgradeSolutionInstance(respData.data.data.instanceId));
    yield put(
      actions.hideLoader({
...
export function* fetchMapFieldMeetingListSaga(action) {
  ...
  try {
    ...
    console.log(e);
    yield put(actions.fetchMapMeetingDataFail("Unable to fetch the Email list"));
    yield put(actions.hideLoader());
  }
}
...
export function* mappedMeetingDataSaga(action) {
  ...
  try {
    ...
    yield put(
      actions.mappedMeetingDataSuccess(respData.data.data, respData.data.msg, respData.data.status) //"Adding data to the Api and redux")
    );
    yield put(actions.upgradeSolutionInstance(respData.data.data.instanceId));
    yield put(
      actions.hideLoader({
...
export function* refreshMapFieldMeetingListSaga(action) {
  ...
  try {
    ...
    console.log(e);
    yield put(actions.refreshMeetingDataFail("Unable to refresh the Email list"));
    yield put(actions.hideLoader());
  }
}
...
export function* mappedLeadDataSaga(action) {
  ...
  try {
    ...
    //alert(respData.data.status)
    if (respData.data.status != 200)
      throw new Error("Unable to Lead Data");
      

    yield put(
      actions.mappedLeadDataSuccess(respData.data.data, respData.data.msg, respData.data.status) //"Adding data to the Api and redux")
    );
    yield put(actions.upgradeSolutionInstance(respData.data.data.instanceId));
    yield put(
      actions.hideLoader({
...
export function* mappedNotesDataSaga(action) {
  ...
  try {
    ...
    //alert(respData.data.status)
    if (respData.data.status != 200)
      throw new Error("Unable to Notes Data");
      

    yield put(
      actions.mappedNotesDataSuccess(respData.data.data, respData.data.msg, respData.data.status) //"Adding data to the Api and redux")
    );
    yield put(actions.upgradeSolutionInstance(respData.data.data.instanceId));
    yield put(
      actions.hideLoader({
...
export function* refreshMapFieldNotesListSaga(action) {
  ...
  try {
    ...
    console.log(e);
    yield put(actions.fetchMapNotesDataFail("Unable to refresh the Notes list"));
    yield put(actions.hideLoader());
  }
}
...
export function* fetchMapFieldAttachListSaga(action) {
  ...
  try {
    ...
    yield put(
      actions.fetchMapAttachmentsDataSuccess(respData.data.data, respData.data.msg) 
    );
    yield put(
      actions.hideLoader({
        status: "200",
    ...
    console.log(e);
    yield put(actions.fetchMapAttachmentsDataFail("Unable to fetch the Attachments list"));
    yield put(actions.hideLoader());
  }
}
...
export function* mappedAttachDataSaga(action) {
  ...
  try {
    ...
    yield put(
      actions.mappedAttachmentsDataSuccess(respData.data.data, respData.data.msg, respData.data.status) //"Adding data to the Api and redux")
    );
    yield put(actions.upgradeSolutionInstance(respData.data.data.instanceId));
    yield put(
      actions.hideLoader({
...
export function* refreshMapFieldAttachListSaga(action) {
  ...
  try {
    ...
    yield put(
      actions.refreshAttachmentsDataSuccess(respData.data.data, respData.data.msg) 
    );
    yield put(
      actions.hideLoader({
        status: "200",
    ...
    console.log(e);
    yield put(actions.refreshAttachmentsDataFail("Unable to refresh the Attachments list"));
    yield put(actions.hideLoader());
  }
}
...
export function* fetchSelectedObjectListSaga(action) {
  ...
  try {
    ...
    yield put(
      actions.fetchSelectedObjectListSuccess(respData.data.data, respData.data.msg) 
    );
    yield put(
      actions.hideLoader({
        status: "200",
...
export function* mappedSelectedObjectSaga(action) {
  ...
  try {
    ...
    yield put(
      actions.mappedSelectedObjectDataSuccess(respData.data.data, respData.data.msg, respData.data.status) //"Adding data to the Api and redux")
    );
    // yield put(actions.upgradeSolutionInstance(action.payload.instanceId));
    yield put(
      actions.hideLoader({
...
export function* fetchMapFieldTabsListSaga(action) {
  ...
  try {
    ...
    yield put(
      actions.fetchMapFieldTabsListSuccess(respData.data.data, respData.data.msg) 
    );
    yield put(
      actions.hideLoader({
        status: "200",
...
export function* mappedEngageDataSaga(action) {
  ...
  try {
    let respData = yield axios("/api/dataMapping/storeEngagementsMappedData", {
      method: "post",
      // params: {
      //   instanceID: action.payload,
      // },
    ...
    yield put(
      actions.mappedEngageDataSuccess(respData.data.data, respData.data.msg, respData.data.status) //"Adding data to the Api and redux")
    );
    yield put(actions.upgradeSolutionInstance(respData.data.data.instanceId));
    yield put(
      actions.hideLoader({

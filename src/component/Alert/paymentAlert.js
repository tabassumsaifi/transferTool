...
const PaymentAlert = () => {
  ...
  const msg = useSelector((state) => state.paymentLoader.msg);
  const status = useSelector((state) => state.paymentLoader.status);
  const alertStatus = useSelector((state) => state.paymentLoader.alertStatus);

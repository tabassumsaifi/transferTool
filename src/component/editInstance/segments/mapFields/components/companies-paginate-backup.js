...
import PaginationTable from "./paginatioTable";
...
function Companies() {
  ...
  const swapValueHandler = () => {
    ...
    console.log(displayFilterData[firstIndexVal], displayFilterData[secondIndex]);
    ...
    <>
                  ...
                  return (
                    <TableRow key={index}>
                      ...
                      <TableCell
                        ...
                        key={index}
                        id={`lione${row.id}`}
                        onDrag={(event) => onDragStart(event, index)}
     ...
     {JSON.stringify(displayFilterData, null, 2)} 
      ...
      <Grid
        ...
        totalCount={displayFilterData.length<=PageSize?2:displayFilterData.length}
        pageSize={PageSize}
      ...
      />
        ...
        >
          ...
          {/* <PaginationTable displayFilterData={displayFilterData} /> */}
